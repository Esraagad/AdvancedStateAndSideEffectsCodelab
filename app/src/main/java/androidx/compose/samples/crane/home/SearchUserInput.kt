...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editableUserState = rememberEditableUserInputState(hint = "Choose Destination")
    ...
    LaunchedEffect(editableUserState) {
        snapshotFlow { editableUserState.text }
            .filter { !editableUserState.isHint }
            .collect {
                currentOnDestinationChanged(editableUserState.text)
            }
    }
}
